    ...
    return (
        <div className='container'>
            ...
            <div className='d-flex flex-row justify-content-center'>
                <div className='m-4'>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/8eDBlaS67Jk?playlist=8eDBlaS67Jk&loop=1&autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div className='m-4'>
            ...
            <div className='d-flex flex-row m-4 justify-content-around'>
                <div className='box'>
                <a className='btn btn-outline-light' href="https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/que-es-la-clamidia">Clamidia</a>
                ...
                <div className='box'>
                <a  className='btn btn-outline-light' href="https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/verrugas-genitales">Verrugas Genitales</a>
                ...
                <div className='box'>            
                <a className='btn btn-outline-light' href='https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/gonorrea'>Gonorrea</a>
            ...
            <div className='d-flex flex-row m-4 justify-content-around'>
                <div className='box'>
                <a className='btn btn-outline-light' href="https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/que-es-la-hepatitis-b">Hepatitis B</a>
                ...
                <div className='box'>
                <a className='btn btn-outline-light' href="https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/vph">Herpes genital y oral</a>
                ...
                <div className='box'>            
                <a className='btn btn-outline-light' href='https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/vih-sida'>VIH Y SIDA</a>
            ...
            <div className='d-flex flex-row m-4 justify-content-around'>
                <div className='box'>
                <a className='btn btn-outline-light' href="https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/vph">Papiloma Humano</a>
                ...
                <div className='box'>
                <a className='btn btn-outline-light' href="https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/molluscum-contagiosum">Molluscum contagiosum</a>
                ...
                <div className='box'>            
                <a className='btn btn-outline-light' href='https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets/sifilis'>Sífilis</a>
            ...
            <a className='btn btn-outline-light' href='https://www.plannedparenthood.org/es/temas-de-salud/enfermedades-de-transmision-sexual-ets'>Más información</a>
        </div>
    );
}
